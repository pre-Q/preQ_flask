...
common = ['경험', '자신감', '노력', '정확']
passion = ['열심히', '최선', '열정', '충실히', '주도적', '몰입', '성실', '에너지', '활력', '몰두', '끊임없이', '포기하', '활발한', '원동력',
           '의지', '끈기', '투지', '열의', '적극', '깊', '독학', '성장', '배우', '학습', '흥미', '관심', '충실', '실천', '꾸준하', '꾸준히']
collaboration = ['소통', '팀워크', '희생', '갈등', '리더십', '커뮤니케이션', '존중', '협력', '유대', '신뢰', '설득', '조율', '헌신', '경청', '연결',
                 '이해', '공유', '책임', '대화', '도움', '배려', '함께', '융화', '이야기', '나누', '논의', '협의', '합의', '믿음', '공감', '유대감', '유대', '시너지']
challenge = ['시도', '새로운', '도전', '혁신', '창의', '두려워하', '도약', '목표', '변화', '실현', '시작', '용기', '시행', '탐구', '모험',
             '결단력', '실행', '기회', '호기심', '실천', '패기']
problem = ['문제', '전략', '성공', '효율', '방안', '발전', '목적', '건의', '분석', '조사', '개선', '원인', '보완', '해결', '목표', '향상', '성취',
           '성과', '기여', '달성', '접근', '완성', '휼륭', '활용', '최적', '대응', '솔루션', '극복', '대처', '도출', '해내', '발휘', '적용', '처리']
leadership = ['설득', '창의성', '주도', '팀장', '임원', '조장', '회장', '해결', '분위기', '제시', '리드', '리더', '솔선수범', '추진력', '책임',
